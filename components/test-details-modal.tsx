...
export default function TestDetailsModal({ isOpen, onOpenChange, test, subm_eval }: TestDetailsModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4" onClick={() => onOpenChange(false)}>
      <div className="max-h-[90vh] w-full max-w-5xl overflow-hidden rounded-md border-small border-default-300 bg-background shadow-xl" onClick={(e) => e.stopPropagation()}>
        <div className="bg-white p-4 border-b border-default-300">
