...
export type QueryGetCurrentTaskVersionByTaskIdArgs = {
  taskID: Scalars['ID']['input'];
};


export type QueryGetStableTaskVersionByPublishedTaskCodeArgs = {
  taskCode: Scalars['String']['input'];
};
...
export type GetCurrentTaskVersionByTaskIdQueryVariables = Exact<{
  taskID: Scalars['ID']['input'];
}>;


export type GetCurrentTaskVersionByTaskIdQuery = { __typename?: 'Query', getCurrentTaskVersionByTaskID: { __typename?: 'TaskVersion', versionID: string, code: string, name: string, createdAt: string, metadata: { __typename?: 'Metadata', authors?: Array<string> | null, origin?: string | null }, constraints: { __typename?: 'Constraints', timeLimitMs: number, memoryLimitKb: number }, description?: { __typename?: 'Description', story: string, input: string, output: string, notes?: string | null, examples?: Array<{ __typename?: 'Example', input: string, answer: string }> | null } | null } };
...
export type CreateTaskMutation = { __typename?: 'Mutation', createTask: { __typename?: 'Task', taskID: string, createdAt: string, updatedAt: string, current: { __typename?: 'TaskVersion', versionID: string, code: string, name: string, createdAt: string } } };
