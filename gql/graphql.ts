...
export type SetGeneralInfoMutation = { __typename?: 'Mutation', updateTaskDescription: { __typename?: 'Task', code: string }, updateTaskMetadata: { __typename?: 'Task', code: string } };
...
export type GetCurrentTaskVersionGeneralInfoQuery = { __typename?: 'Query', getCurrentTaskVersionByCode: { __typename?: 'Task', name: string, code: string, updatedAt: string, createdAt: string, description: { __typename?: 'Description', story: string, input: string, output: string, notes?: string | null }, metadata: { __typename?: 'Metadata', authors?: Array<string> | null } } };
...
export type SetStatementMutation = { __typename?: 'Mutation', updateTaskDescription: { __typename?: 'Task', code: string } };
...
export type GetCurrentTaskVersionStatementQuery = { __typename?: 'Query', getCurrentTaskVersionByCode: { __typename?: 'Task', name: string, code: string, description: { __typename?: 'Description', story: string, input: string, output: string, notes?: string | null } } };
...
export type EnqueueSubmissionForPublishedTaskVersionMutation = { __typename?: 'Mutation', enqueueSubmissionForPublishedTaskVersion: { __typename?: 'Submission', id: string } };
...
export type GetTaskDescriptionQuery = { __typename?: 'Query', getPublishedTaskVersionByCode: { __typename?: 'Task', code: string, name: string, createdAt: string, updatedAt: string, description: { __typename?: 'Description', story: string, input: string, output: string, notes?: string | null, examples?: Array<{ __typename?: 'Example', id: string, input: string, answer: string }> | null }, constraints: { __typename?: 'Constraints', timeLimitMs: number, memoryLimitKb: number }, metadata: { __typename?: 'Metadata', authors?: Array<string> | null, origin?: string | null } } };
...
export type ListPublishedTasksQuery = { __typename?: 'Query', listPublishedTasks: Array<{ __typename?: 'Task', createdAt: string, updatedAt: string, code: string, name: string, solved?: boolean | null, constraints: { __typename?: 'Constraints', timeLimitMs: number, memoryLimitKb: number }, metadata: { __typename?: 'Metadata', authors?: Array<string> | null, origin?: string | null }, tests: Array<{ __typename?: 'Test', id: string, name: string, input: string, answer: string }>, description: { __typename?: 'Description', story: string, input: string, output: string, notes?: string | null, examples?: Array<{ __typename?: 'Example', id: string, input: string, answer: string }> | null } }> };
...
export const CreateNewTaskDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"createNewTask"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"code"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"name"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createTask"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"code"},"value":{"kind":"Variable","name":{"kind":"Name","value":"code"}}},{"kind":"Argument","name":{"kind":"Name","value":"name"},"value":{"kind":"Variable","name":{"kind":"Name","value":"name"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"code"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}}]} as unknown as DocumentNode<CreateNewTaskMutation, CreateNewTaskMutationVariables>;
