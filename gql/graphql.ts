...
export type Query = {
  ...
  listSolvedPublishedTaskCodesByUsername: Array<Scalars['String']['output']>;
  whoami?: Maybe<User>;
};
...
export type QueryListSolvedPublishedTaskCodesByUsernameArgs = {
  username: Scalars['String']['input'];
};
...
export type SubscriptionOnSubmissionUpdateArgs = {
...
export type ListPublicSubmissionsForSubmissionListQuery = { __typename?: 'Query', listPublicSubmissions: Array<{ __typename?: 'SubmissionOverview', id: string, submission: string, username: string, createdAt: string, evaluation: { __typename?: 'ShallowEvaluation', id: string, status: string, totalScore: number, possibleScore?: number | null }, language: { __typename?: 'ProgrammingLanguage', id: string, fullName: string, monacoID?: string | null, enabled: boolean }, task: { __typename?: 'TaskOverview', taskID: string, name: string, code: string } }> };

export type WhoamiTasksListQueryVariables = Exact<{ [key: string]: never; }>;


export type WhoamiTasksListQuery = { __typename?: 'Query', whoami?: { __typename?: 'User', id: string, username: string, email: string, firstName: string, lastName: string } | null };

export type ListSolvedPublishedTaskCodesByUsernameQueryVariables = Exact<{
  username: Scalars['String']['input'];
}>;


export type ListSolvedPublishedTaskCodesByUsernameQuery = { __typename?: 'Query', listSolvedPublishedTaskCodesByUsername: Array<string> };
...
export type EnqueueSubmissionForPublishedTaskCodeStableTaskVersionMutationVariables = Exact<{
  taskCode: Scalars['String']['input'];
  languageID: Scalars['ID']['input'];
  submissionCode: Scalars['String']['input'];
}>;
...
export type EnqueueSubmissionForPublishedTaskCodeStableTaskVersionMutation = { __typename?: 'Mutation', enqueueSubmissionForPublishedTaskCodeStableTaskVersion: { __typename?: 'Submission', id: string, submission: string, username: string, createdAt: string, evaluation: { __typename?: 'Evaluation', id: string, status: string, totalScore: number, possibleScore?: number | null } } };
...
export type OnSubmissionUpdateSubscriptionVariables = Exact<{
  submissionId: Scalars['ID']['input'];
}>;


export type OnSubmissionUpdateSubscription = { __typename?: 'Subscription', onSubmissionUpdate: { __typename?: 'Submission', id: string, submission: string, username: string, createdAt: string, evaluation: { __typename?: 'Evaluation', id: string, status: string, totalScore: number, possibleScore?: number | null } } };
...
export type LoginMutation = { __typename?: 'Mutation', login: { __typename?: 'User', id: string, username: string, email: string, firstName: string, lastName: string, isAdmin: boolean } };
...
export const WhoamiTasksListDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"WhoamiTasksList"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"whoami"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"username"}},{"kind":"Field","name":{"kind":"Name","value":"email"}},{"kind":"Field","name":{"kind":"Name","value":"firstName"}},{"kind":"Field","name":{"kind":"Name","value":"lastName"}}]}}]}}]} as unknown as DocumentNode<WhoamiTasksListQuery, WhoamiTasksListQueryVariables>;
export const ListSolvedPublishedTaskCodesByUsernameDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"ListSolvedPublishedTaskCodesByUsername"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"username"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"listSolvedPublishedTaskCodesByUsername"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"username"},"value":{"kind":"Variable","name":{"kind":"Name","value":"username"}}}]}]}}]} as unknown as DocumentNode<ListSolvedPublishedTaskCodesByUsernameQuery, ListSolvedPublishedTaskCodesByUsernameQueryVariables>;
...
export const EnqueueSubmissionForPublishedTaskCodeStableTaskVersionDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"EnqueueSubmissionForPublishedTaskCodeStableTaskVersion"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"taskCode"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"languageID"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"submissionCode"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"enqueueSubmissionForPublishedTaskCodeStableTaskVersion"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"taskCode"},"value":{"kind":"Variable","name":{"kind":"Name","value":"taskCode"}}},{"kind":"Argument","name":{"kind":"Name","value":"languageID"},"value":{"kind":"Variable","name":{"kind":"Name","value":"languageID"}}},{"kind":"Argument","name":{"kind":"Name","value":"submissionCode"},"value":{"kind":"Variable","name":{"kind":"Name","value":"submissionCode"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"submission"}},{"kind":"Field","name":{"kind":"Name","value":"username"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"evaluation"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"totalScore"}},{"kind":"Field","name":{"kind":"Name","value":"possibleScore"}}]}}]}}]}}]} as unknown as DocumentNode<EnqueueSubmissionForPublishedTaskCodeStableTaskVersionMutation, EnqueueSubmissionForPublishedTaskCodeStableTaskVersionMutationVariables>;
...
export const OnSubmissionUpdateDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"subscription","name":{"kind":"Name","value":"OnSubmissionUpdate"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"submissionId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"onSubmissionUpdate"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"submissionId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"submissionId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"submission"}},{"kind":"Field","name":{"kind":"Name","value":"username"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"evaluation"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"totalScore"}},{"kind":"Field","name":{"kind":"Name","value":"possibleScore"}}]}}]}}]}}]} as unknown as DocumentNode<OnSubmissionUpdateSubscription, OnSubmissionUpdateSubscriptionVariables>;
